...
# Assurez-vous que Ganache est en cours d'exécution sur votre machine

# Remplacez l'URL par l'URL RPC fournie par votre instance Ganache
ganache_url = "http://127.0.0.1:7545" 

# Connectez Web3 à l'instance Ganache
...
# Votre code Web3 pour interagir avec Ganache
