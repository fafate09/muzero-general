...
class Game(AbstractGame):
    def __init__(self, seed=None):
        ...
        self.reward_curve = []
        self.coherence_reward_trace = []  # Liste pour stocker (coherence, reward) de chaque action testée
    ...
    def step(self, actions):
        ...
        for node in self.graph.nodes:
            ...
            for action in legal_actions:
                ...
                print(f"    ➤ Action {action} → Coherence: {round(new_coherence_measure, 4)} | Reward: {round(reward_for_action, 4)}")
                self.coherence_reward_trace.append((new_coherence_measure, reward_for_action))
        ...
        print(f"(SelfPlay pid=2136) Final Coherence: {round(final_coherence_measure, 4)}")
